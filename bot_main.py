...
# === ВСТАВЬ СВОЙ ТОКЕН И ID ЗДЕСЬ ===
BOT_TOKEN = "8403035412:AAHePhUD99Xke_DfghRp_UnfmuMytMgXwIE"  # ТВОЙ ТОКЕН
OWNER_ID = 8294608065  # ТВОЙ ID ВЛАДЕЛЬЦА
# =====================================
...
ADMIN_PERMISSIONS = {
    ...
    "head": ["checklog", "checkadmin", "newtt", "testlog", "admlog", "chats", "leave", "leaveadm"],
